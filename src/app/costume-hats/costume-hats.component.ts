...
function filter() {
  const filter = <HTMLSelectElement>document.getElementById('hat-filter');
...
@Component({
  selector: 'app-costume-hats',
  templateUrl: './costume-hats.component.html',
  styleUrls: ['./costume-hats.component.css']
})
export class CostumeHatsComponent implements OnInit {
